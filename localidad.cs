...
namespace pryGrafeuilleTPagricola
{
    public partial class frmlocalidad : Form
    {
        ...
        private void btnCrearLo_Click(object sender, EventArgs e)
        {
            File.Create("./Localidades.txt");
            MessageBox.Show("Creaste un archivo Localidades");
        }

        private void btnEditarLo_Click(object sender, EventArgs e)
        {
